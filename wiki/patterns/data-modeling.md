...
> **Note:** These patterns target the **Supabase MVP tier** — Postgres with RLS, JSONB, PostGIS. For the production tier (Neon + Drizzle), see [[architecture/database]].
...
- [[decisions/adr-001-supabase-postgis]]
