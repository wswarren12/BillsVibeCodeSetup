...
- **Always update [[wiki/index]]** — every new page must be cataloged
...
- Link to relevant existing wiki pages using `[[wikilinks]]`
...
- Add all new pages to [[wiki/index]] under the appropriate section
- Follow the format: `- [[category/page-name]] — One-line summary`

## Step 6: Log

- Append to [[wiki/log]] with:
  - Date
